<x-other-layout>
    {{-- <div class="mx-auto max-w-7xl">
        <div class="grid place-content-center ">
            <x-shared.approval class="h-40" />
            <span class="text-center mt-2">Waiting for approval</span>
        </div>
    </div> --}}
    ...
    <div class="relative isolate px-6  lg:px-8">
        ...
        <div class="mx-auto max-w-2xl py-32 sm:py-48 lg:py-56">
            ...
            <div class="text-center">
                <h1 class="text-5xl font-black tracking-tight italic text-balance text-main sm:text-7xl">LAUNDRIZZ</h1>


                <div class=" sm:mb-8 mt-10 flex justify-center">
                    <x-shared.approval class="h-40 animate-pulse" />
                </div>
